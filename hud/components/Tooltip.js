...
export function createTooltip(host) {
  ...
  el.hidden = true;
  // Attach to <body>, NOT to `host`: the layout re-renders by resetting its own
  // innerHTML, which would otherwise detach (and break) the tooltip element.
  // The hover listeners below stay on `host` (it persists across re-renders).
