...
function setupSceneSelection(hooks = {}) {
  ...
  const cleanups3 = [];
  const inFlightCombatActionKeys = /* @__PURE__ */ new Set();
  const inFlightCombatActionCharacters = /* @__PURE__ */ new Set();
  function waitMs(ms) {
  ...
  async function init() {
    ...
    async function refreshSelectedCharacterRuntime(reason = "generic", { refreshQuickbar = false } = {}) {
      logDebugEvent(
        "runtime",
...
var MOVE_TOOL_ICON_URL = "https://odyssey-services.github.io/Odyssey_System/icon.svg?v=1.8.75";
