...
function entryRow(entry, selectedKey) {
  ...
  const statusClass = normalizedStatus === "pending" ? "is-pending" : entry.success === false ? "is-failure" : "is-success";
