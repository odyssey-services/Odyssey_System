update public.odyssey_character_ammo_stock stock
set caliber_id = ammo.caliber_id
from public.odyssey_ammo_type_defs ammo
where ammo.id = stock.ammo_type_id
  and stock.caliber_id is distinct from ammo.caliber_id;
